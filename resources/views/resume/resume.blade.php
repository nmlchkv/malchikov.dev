...
<head>
    ...
    <title>Nikolai Malchikov - Resume</title>
    <style>
        body {
...
<div class="container">
    ...
    <p><strong>Frameworks:</strong> Laravel, Symfony</p>
    <p><strong>Tools:</strong> Docker, Composer, PHPUnit, Unit Testing, GitLab CI/CD, Swagger, Scribe, PHPStorm</p>
    <p><strong>Principles:</strong> OOP, SOLID</p>
    ...
    <p><strong>Technologies:</strong> PHP 7+, Laravel, Symfony, Docker, MySQL.</p>
    <h2>EDUCATION</h2>
